...
Original file is located at
    https://colab.research.google.com/drive/1qWleIcPfltjb2mSOkN_lusMIlzp-JSdt
"""
...
data = np.random.rand(1000, 32, 32, 3)  # Example data: 1000 images of size 32x32 with 3 color channels
